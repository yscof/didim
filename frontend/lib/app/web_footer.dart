...
/// 웹 페이지 하단 공통 Footer. WebPageBody가 페이지 맨 아래에 부착한다
/// (웹 레이아웃일 때만). 배경과 경계선은 화면 전체 폭으로 깔리고 내용만
/// 본문과 같은 폭(960)으로 가운데 정렬된다. 문구 근거: docs/18-compliance.md.
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    _FooterLink(
                        label: '서비스 소개', onTap: () => context.go('/about')),
                    _FooterDot(),
                    _FooterLink(
                        label: '이용약관', onTap: () => context.push('/terms')),
                    _FooterDot(),
                    _FooterLink(
                        label: '개인정보처리방침',
